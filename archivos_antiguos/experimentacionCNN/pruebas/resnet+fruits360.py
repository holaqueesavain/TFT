...
modelo = load_model(f'C:\\ARIS\\universidad\\TFG\\Programa\\experimentacionCNN\\modelos\\resnet50_frutas.h5')

with open(f'C:\\ARIS\\universidad\\TFG\\Programa\\experimentacionCNN\\modelos\\clases_frutas_resnet.json', 'r', encoding='utf-8') as f:
    class_indices = json.load(f)
idx_to_class = {v: k for k, v in class_indices.items()}

fruit_classes = set(idx_to_class.values())
...
bg_path = f"C:\\ARIS\\universidad\\TFG\\Programa\\experimentacionCNN\\pruebas\\capturas\\base.jpg"
bg_img = cv2.imread(bg_path)
if bg_img is None:
    raise FileNotFoundError(f"'base.jpg' no encontrado: {bg_path}")

image_paths = [
    f"C:\\ARIS\\universidad\\TFG\\Programa\\experimentacionCNN\\pruebas\\capturas\\Img{i}.jpg"
    for i in range(2, 11)
]
processed_imgs = []
label_texts = []
...
output_path = "output\\mosaico_resnet50_frutas.jpg"
