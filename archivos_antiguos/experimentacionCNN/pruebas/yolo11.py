...
model = YOLO('C:\\ARIS\\universidad\\TFG\\Programa\\experimentacionCNN\\modelos\\yolo11n.pt')
...
cv2.imwrite("output\\mosaico_yolo_11n.jpg", mosaic)
print("Guardado: output\\mosaico_yolo_11n.jpg")
