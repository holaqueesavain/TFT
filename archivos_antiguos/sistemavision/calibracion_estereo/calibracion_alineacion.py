...
# ----------------------------------------------------
# ---------- Calibrador para la alineacion -----------
# -------------- visual de las camaras ---------------
# ----------------------------------------------------
"""Software que combina imagenes de ambas camaras
para facilitar la alineacion fisica y calibracion
de parametros del algoritmo de disparidad SGBM."""
...
print("Presiona 'q' para salir y ver configuración final.")
...
while True:
    ...
    overlay[:, :, 1] = grayL  # Verde = izquierda
    overlay[:, :, 2] = grayR  # Rojo = derecha
    ...
    cv2.putText(heatmap, f"Z ≈ {Z:.2f} m", (10, 30),
