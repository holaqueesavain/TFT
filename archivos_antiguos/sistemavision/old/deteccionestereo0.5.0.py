...
con YOLOv8n. Solo se detectan frutas dentro del área de malla.
    ...
    if key == ord('q'):
        ...
        if not captured_i:
            ...
            if retL:
                ...
                # detectar frutas con YOLO SOBRE img_f
                results = model(img_f, conf=0.25, iou=0.45, imgsz=640, verbose=False)
                fruit_boxes = []
                for box in results[0].boxes:
                    cls_name = model.names[int(box.cls[0].cpu().numpy())]
                ...
                for det in valid_detections:
                    ...
                    if xyz_bottom is not None:
                        ...
                        if altura_estimada < 0.01 or altura_estimada > 0.20:
                            ...
                            altura_estimada = 0.10 #valor por defecto
                        else:
