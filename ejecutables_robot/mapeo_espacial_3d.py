"""
El robot se desplaza por diferentes puntos del espacio de trabajo y, en cada posición,
se registra su ubicación real junto con la estimada por el sistema de visión. Los datos
obtenidos se almacenan en un archivo CSV.
"""
