...
print("Iniciando prueba de Color - Teclas: 'v' Verde, 'r' Rojo, 'ESC' Salir")
...
while True:
    ...
    cv2.putText(display, f"Modo: {label}", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.8, color, 2)
    cv2.putText(display, f"Ruido (objetos pequenyos): {ruido}", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.6, color, 1)

    cv2.imshow("Prueba de Color", display)
