...
def main():
    ...
    f_csv = open("comparativa_modelos.csv", "w", newline="")
    writer = csv.writer(f_csv, delimiter=";")
    writer.writerow(["Tiempo", "Err_Lin", "Err_Mat", "Err_RBF", "Ms_Lin", "Ms_Mat", "Ms_RBF"])
    ...
    while True:
        ...
        if mano:
            ...
            writer.writerow([time.time(), err_lineal, err_matriz, err_rbf, t_lineal_ms, t_matriz_ms, t_rbf_ms])
